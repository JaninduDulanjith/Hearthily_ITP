...
import Users from './Pages/EmpManage/Users';
import UpdateUsers from './Pages/EmpManage/UpdateUser';
import CreateUser from './Pages/EmpManage/CreateUser';
import LeavingForm from './Pages/EmpManage/LeavingForm';
import LeaveForm from './Pages/EmpManage/LeaveForm';
import LeaveDetails from './Pages/EmpManage/LevingDetails';
import Calculate from './Pages/EmpManage/CalulateSalary';
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path='/leaving-form/:id' element={<LeavingForm/>}/>
          <Route path='/leave' element={<LeaveForm/>}/>
          <Route path="/leave_Details" element={<LeaveDetails />} />
          <Route path="/CalculateSalary" element={<Calculate />} />
